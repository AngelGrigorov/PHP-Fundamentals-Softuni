...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\LibraryType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\LibraryType']) ? $this->services['AppBundle\Form\LibraryType'] : $this->services['AppBundle\Form\LibraryType'] = new \AppBundle\Form\LibraryType()) && false ?: '_'};
